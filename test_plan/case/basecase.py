...
class BaseCase(unittest.TestCase):   # 继承unittest.TestCase
    ...
    def setUpClass(cls):
        if cls.__name__ != 'BaseCase':
            cls.data_list = excel_to_list(cls.data_file, cls.__name__)
    ...
    def send_request(self, case_data):
        ...
        if method.upper() == 'GET':   # GET类型请求
            ...
            log_case_info(case_name, url, args, json.dumps(json.loads(expect_res),ensure_ascii=False, sort_keys=True),
